...
<img src="../pictures_namefiles/{}" width="2000" style="display: block; margin-right: auto; margin-left: auto;">
</div>
...
style='font-size:56.0pt;line-height:107%;font-family:"Garamond",serif;
color:#FFF2CC'>&nbsp;</span></b></p>\n\n'''

    return '''
    <p class=MsoNormal><b><span style='font-size:56.0pt;line-height:107%;
